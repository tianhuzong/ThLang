...
class NBlock : public Node {
    public:
        std::unique_ptr<std::vector<std::unique_ptr<thlang::Node>>> stmts = std::make_unique<std::vector<std::unique_ptr<thlang::Node>>>();
        NBlock() {}
...
class BinOpAst : public ExprAst {
    public:
        ...
        BinOpAst(std::string op, std::unique_ptr<thlang::Node> left, std::unique_ptr<thlang::Node> right) : op(op), left(std::move(left)), right(std::move(right)) {}
        virtual llvm::Value* codegen(thlang::CodeGenContext& context) override ;
        virtual void unparse();
};
...
public:
    ...
    IfStmtAst(std::unique_ptr<thlang::Node> condition, std::unique_ptr<thlang::Node> thenStmt, std::unique_ptr<thlang::Node> elseStmt = nullptr) : condition(std::move(condition)), thenStmt(std::move(thenStmt)), elseStmt(std::move(elseStmt)) {};
    virtual llvm::Value* codegen(CodeGenContext& context) override; 
    virtual void unparse() override;
};
...
public:
    ...
    ForStmtAst(std::unique_ptr<thlang::Node> init, std::unique_ptr<thlang::Node> condition, std::unique_ptr<thlang::Node> increment, std::unique_ptr<thlang::Node> body) : init(std::move(init)), condition(std::move(condition)), increment(std::move(increment)), body(std::move(body)) {};
    virtual llvm::Value* codegen(CodeGenContext& context) override; 
    virtual void unparse() override;
};
...
public:
    std::unique_ptr<thlang::Node> condition;
    std::unique_ptr<thlang::Node> body;
    WhileStmtAst(std::unique_ptr<thlang::Node> condition, std::unique_ptr<thlang::Node> body) : condition(std::move(condition)), body(std::move(body)) {};
    virtual llvm::Value* codegen(CodeGenContext& context) override; 
    virtual void unparse() override;
};
