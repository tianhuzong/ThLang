...
namespace thlang {
std::string &Type::get_type_name() { return type_name; }
...
std::string &FunctionType::get_type_name() { return type_name; }

std::string &ClassType::get_type_name() { return type_name; }
...
std::string &StructType::get_type_name() { return type_name; }
